    ...
    const modalContent = {
        ...
        'aivory-design': {
            ...
            content: `
                <h2>아이보리 피그마 구현</h2>
                <div class="media-frame">
                    <iframe style="border: 0; width:100%; height:950px;" src="https://embed.figma.com/proto/59YPP7a7K5T0I7X1KBx1px/%ED%94%84%EB%A1%9C%EC%A0%9D%ED%8A%B82--%EC%95%84%EC%9D%B4%EB%B3%B4%EB%A6%AC-?page-id=0%3A1&node-id=1-1094&viewport=-383%2C246%2C0.32&scaling=min-zoom&content-scaling=fixed&starting-point-node-id=1%3A1071&embed-host=share" allowfullscreen></iframe>
                </div>
            `
        },
        'since-ux': {
        ...
        'since-design': {
            ...
            content: `
                ...
                <div class="media-frame">
                    <iframe style="border: 0; width:100%; height:950px;" src="https://embed.figma.com/proto/KsstKbzPZEtUfoLdWQQQMM/%ED%94%84%EB%A1%9C%EC%A0%9D%ED%8A%B83_Since-18?page-id=0%3A1&node-id=1-28&viewport=351%2C25%2C0.21&scaling=min-zoom&content-scaling=fixed&embed-host=share" allowfullscreen></iframe>
                </div>
                <p>확대해서 확인해보세요.</p>
